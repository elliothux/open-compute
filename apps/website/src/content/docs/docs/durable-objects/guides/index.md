...
See [Get started](/docs/durable-objects/get-started/). The binding must include `class_name`.
...
Alarms: [alarms](/docs/durable-objects/alarms). Hibernation: [WebSockets](/docs/workers/runtime-apis/websockets) or [Concepts](/docs/durable-objects/concepts/).
