...
| ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Handlers (`fetch`, `scheduled`, `queue`)                                 | [Handlers](https://developers.cloudflare.com/workers/runtime-apis/handlers/)            | [handlers](/docs/workers/runtime-apis/handlers)                            |
| Bindings / `env`                                                         | [Bindings](https://developers.cloudflare.com/workers/runtime-apis/bindings/)            | [bindings](/docs/workers/runtime-apis/bindings)                            |
| Cache API                                                                | [Cache](https://developers.cloudflare.com/workers/runtime-apis/cache/)                  | [cache](/docs/workers/runtime-apis/cache)                                  |
| WebSockets                                                               | [WebSockets](https://developers.cloudflare.com/workers/runtime-apis/websockets/)        | [websockets](/docs/workers/runtime-apis/websockets); hibernation available |
| TCP sockets                                                              | [TCP sockets](https://developers.cloudflare.com/workers/runtime-apis/tcp-sockets/)      | [tcp-sockets](/docs/workers/runtime-apis/tcp-sockets)                      |
| Node.js                                                                  | [Node.js compatibility](https://developers.cloudflare.com/workers/runtime-apis/nodejs/) | [nodejs](/docs/workers/runtime-apis/nodejs)                                |
...
| Request-scoped CPU / subrequest quotas                                   | Yes                      | See [Limits](/docs/workers/platform/limits)                                                                       |
