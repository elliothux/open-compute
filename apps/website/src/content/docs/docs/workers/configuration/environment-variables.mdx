...
<Tabs syncKey="package-manager">
  <TabItem label="npm">```sh npm exec -- wrangler types ```</TabItem>
  <TabItem label="pnpm">```sh pnpm exec wrangler types ```</TabItem>
  <TabItem label="bun">```sh bun run wrangler types ```</TabItem>
</Tabs>
