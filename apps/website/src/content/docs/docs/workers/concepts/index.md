...
| Outbound network                                                                       | Cloudflare hosted network policy                                                                          | Tenant general outbound shares stock workerd's one `Network(allow = ["public"])`; see [TCP sockets](/docs/workers/runtime-apis/tcp-sockets) |
| Request-scoped CPU / subrequest quotas                                                 | Yes                                                                                                       | Not enforced by stock OSS workerd `LimitEnforcer`; live numbers on [Limits](/docs/workers/platform/limits)                                  |
