...
| Outbound network policy                      | Cloudflare hosted TCP policy | See [TCP sockets](/docs/workers/runtime-apis/tcp-sockets)                           |
| Request-scoped CPU / subrequest quotas       | Yes                          | Not enforced; see [Limits](/docs/workers/platform/limits)                           |
