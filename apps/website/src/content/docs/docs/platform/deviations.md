...
| Request-scoped CPU / subrequest / simultaneous-connection quotas                            | Pinned open-source workerd standalone process does not enforce                                        | [Workers limits](/docs/workers/platform/limits)                     |
