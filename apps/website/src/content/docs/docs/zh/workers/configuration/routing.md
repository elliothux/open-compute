...
HTTP 请求到达绑定了该 Worker 的路径后，由 `fetch` handler 处理。Static Assets 的 HTML trailing-slash / SPA / Worker-first 路由概念与 [Cloudflare Static Assets routing](https://developers.cloudflare.com/workers/static-assets/) 对齐，见 [Static Assets](/docs/zh/workers/static-assets/)。
...
| Static Assets HTML trailing-slash / SPA / Worker-first                                            | 是                                   | 是，见 [Static Assets](/docs/zh/workers/static-assets/) |
