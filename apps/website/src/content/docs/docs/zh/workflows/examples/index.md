...
`create` / `get` / `step.do` / `status` 与 [Cloudflare Workflows](https://developers.cloudflare.com/workflows/) 对齐。`class_name` 必须有。步骤状态存在本机 SQLite。创建 definition 见[上手](/docs/zh/workflows/get-started/)。
