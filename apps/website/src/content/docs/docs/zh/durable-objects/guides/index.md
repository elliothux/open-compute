...
见[上手](/docs/zh/durable-objects/get-started/)。binding 必须有 `class_name`。
...
Alarms：[alarms](/docs/zh/durable-objects/alarms)。Hibernation：[WebSockets](/docs/zh/workers/runtime-apis/websockets) 或[概念](/docs/zh/durable-objects/concepts/)。
