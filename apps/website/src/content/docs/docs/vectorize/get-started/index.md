...
You supply vectors; open-compute does not generate embeddings. For document ingest + embedding + retrieval, see [AI Search](/docs/ai-search/).
...
Next: [Concepts](/docs/vectorize/concepts/).
