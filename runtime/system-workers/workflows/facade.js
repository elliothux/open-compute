// Generated from runtime/src/workflows/facade.ts by Rolldown. Do not edit.
...
export class WorkflowBinding {
	...
	async create(options = {}) {
		...
		if (!options || typeof options !== "object" || Array.isArray(options) || Object.keys(options).some((key) => !["id", "params"].includes(key))) {
			throw workflowError("WORKFLOW_METHOD_UNSUPPORTED");
		}
...
function rawTransport(raw) {
	return raw !== null && typeof raw === "object" && "create" in raw && typeof raw.create === "function" && "get" in raw && typeof raw.get === "function" && "status" in raw && typeof raw.status === "function";
}
