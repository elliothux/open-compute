...
import type { WorkflowCallback, WorkflowClass, WorkflowControllerV2, WorkflowDeclaration, WorkflowEventWire, WorkflowProtocolError, WorkflowRunResult, WorkflowVerdict } from "./execution-protocol.js";
...
export async function runWorkflow(target: unknown, ctx: ExecutionContext, env: Record<string, unknown>, event: WorkflowEventWire, backend: WorkflowControllerV2): Promise<WorkflowRunResult> {
