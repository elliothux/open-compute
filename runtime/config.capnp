...
const ingressWorker :Workerd.Worker = (
  ...
  modules = [
    (name = "gateway/ingress.js", esModule = embed "system-workers/gateway/ingress.js"),
  ],
  bindings = [
...
const loaderHostWorker :Workerd.Worker = (
  ...
  modules = [
    ...
    (name = "workflows/host.js", esModule = embed "system-workers/workflows/host.js"),
    (name = "workflows/controller-v2.js", esModule = embed "system-workers/workflows/controller-v2.js"),
    (name = "loader/modules.js", esModule = embed "system-workers/loader/modules.js"),
    (name = "loader/snapshot.js", esModule = embed "system-workers/loader/snapshot.js"),
    (name = "kv/transport.js", esModule = embed "system-workers/kv/transport.js"),
    (name = "loader/wrapper-runtime-source", text = embed "system-workers/loader/wrappers/runtime.js"),
    (name = "loader/do-wrapper-source", text = embed "system-workers/loader/wrappers/durable-object.js"),
    (name = "loader/workflow-wrapper-source", text = embed "system-workers/loader/wrappers/workflow.js"),
    (name = "loader/workflow-runner-source", text = embed "system-workers/workflows/runner.js"),
    (name = "loader/workflow-runner-v2-source", text = embed "system-workers/workflows/runner-v2.js"),
    (name = "loader/workflow-json-source", text = embed "system-workers/workflows/json.js"),
    (name = "loader/workflow-json-v2-source", text = embed "system-workers/workflows/json-v2.js"),
    (name = "loader/workflow-facade-source", text = embed "system-workers/workflows/facade.js"),
    (name = "loader/workflow-facade-v2-source", text = embed "system-workers/workflows/facade-v2.js"),
    (name = "loader/r2-facade-source", text = embed "system-workers/r2/facade.js"),
    (name = "loader/d1-facade-source", text = embed "system-workers/d1/facade.js"),
    (name = "loader/do-facade-source", text = embed "system-workers/durable-objects/facade.js"),
    (name = "loader/do-id-codec-source", text = embed "system-workers/durable-objects/id-codec.js"),
    (name = "loader/do-alarm-shim-source", text = embed "system-workers/durable-objects/alarm-shim.js"),
    (name = "loader/queue-facade-source", text = embed "system-workers/queues/facade.js"),
    (name = "loader/wrappers/generator.js", esModule = embed "system-workers/loader/wrappers/generator.js"),
    (name = "workflows/binding-v2.js", esModule = embed "system-workers/workflows/binding-v2.js"),
    (name = "loader/bindings.js", esModule = embed "system-workers/loader/bindings.js"),
...
const doHostWorker :Workerd.Worker = (
  ...
  compatibilityFlags = ["nodejs_compat", "rpc", "enable_ctx_exports", "experimental"],
  modules = [
    (name = "durable-objects/router.js", esModule = embed "system-workers/durable-objects/router.js"),
    (name = "durable-objects/host.js", esModule = embed "system-workers/durable-objects/host.js"),
    (name = "loader/host.js", esModule = embed "system-workers/loader/host.js"),
    (name = "workflows/host.js", esModule = embed "system-workers/workflows/host.js"),
    (name = "workflows/controller-v2.js", esModule = embed "system-workers/workflows/controller-v2.js"),
    (name = "loader/modules.js", esModule = embed "system-workers/loader/modules.js"),
...
const outboundGatewayWorker :Workerd.Worker = (
  ...
  compatibilityFlags = ["nodejs_compat", "rpc", "enable_ctx_exports", "experimental"],
  modules = [
    (name = "gateway/outbound.js", esModule = embed "system-workers/gateway/outbound.js"),
  ],
