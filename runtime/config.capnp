...
const loaderHostWorker :Workerd.Worker = (
  ...
  modules = [
    ...
    (name = "workflow-host.js", esModule = embed "system-workers/workflow-host.js"),
    (name = "workflow-controller-v2.js", esModule = embed "system-workers/workflow-controller-v2.js"),
    (name = "loaded-isolate-modules.js", esModule = embed "system-workers/loaded-isolate-modules.js"),
    (name = "workflow-runner-source", text = embed "system-workers/workflow-runner.js"),
    (name = "workflow-runner-v2-source", text = embed "system-workers/workflow-runner-v2.js"),
    (name = "workflow-json-source", text = embed "system-workers/workflow-json.js"),
    (name = "workflow-json-v2-source", text = embed "system-workers/workflow-json-v2.js"),
    (name = "workflow-facade-source", text = embed "system-workers/workflow-facade.js"),
    (name = "workflow-facade-v2-source", text = embed "system-workers/workflow-facade-v2.js"),
    ...
    (name = "loaded-isolate-wrapper-generator-v2.js", esModule = embed "system-workers/loaded-isolate-wrapper-generator-v2.js"),
    (name = "workflow-binding-v2.js", esModule = embed "system-workers/workflow-binding-v2.js"),
    (name = "loaded-isolate-wrapper-generator-v3.js", esModule = embed "system-workers/loaded-isolate-wrapper-generator-v3.js"),
    (name = "loaded-isolate-bindings.js", esModule = embed "system-workers/loaded-isolate-bindings.js"),
