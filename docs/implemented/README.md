...
| P5 Vectorize/AI Search | [p5-vectorize-ai-search.md](p5-vectorize-ai-search.md)、[P5.1 parser isolation](p5-1-xberg-document-parsing.md)、[P5.2 AI provider backend/profile](p5-2-ai-provider-profiles.md)、[P5.3 格式/OCR/VLM](p5-3-document-formats-ocr-vlm.md) |
