...
| fork checkout HEAD                                                | `1c7b89bea323a39a8511271913820f9fcf39306d`（已推送 fork `main`）                                                                                                                                                                           |
| upstream base                                                     | `679c09e5eea0af8a04062e1875e99c75af532e3b`（upstream `v1.20260918.1`）                                                                                                                                                                     |
| HEAD 提交说明                                                     | `540983b18` W1 Loader、`5465cdfd9` W2 Standard limits、`19046b1d2` W3 native bindings；`409370774` 为此前手动正式二进制构建；`1c7b89bea` 为 I102 private env、grant 与撤销 fence                                                           |
| fork working tree                                                 | 本次记录时 clean；相对 upstream ahead 5                                                                                                                                                                                                    |
| fork source tree                                                  | `4b346b9959b0ab89753b06d941bdbf10f22f083308c6bc152c8e20ab31ed2778`（`sha256(git-ls-tree-r-full-tree)`）                                                                                                                                    |
| W3 runtime                                                        | `workerd 2026-09-18`；native Provider FD/Cap'n Proto unary/stream 回归通过                                                                                                                                                                 |
| open-compute 当前正式 pin                                         | `v1.20260918.1-open-compute-i102.1c7b89be` / `1c7b89bea323a39a8511271913820f9fcf39306d`（四平台输入均来自 [run 35592596362](https://github.com/elliothux/workerd/actions/runs/35592596362)；成功后以 `bun scripts/build-workerd.ts` 验证） |
