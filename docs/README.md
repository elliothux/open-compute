...
| [I42–67 GitHub open issues 剩余实施批次](i42-67-github-open-issues.md)             | P15/`#51` 与 W2/`#67` 已归档；剩余 `#66`、`#61`、`#62`、`#42`、`#58`，覆盖部署/runtime 可用性、operator proxy 与 manual AI Search source                                                                               |
