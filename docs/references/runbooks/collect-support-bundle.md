...
预期 archive mode 0600，内容仅含 allowlisted release、redacted policy、doctor、metrics、schema、bounded
...
error/counter。secret scanner 覆盖 master key、S3/admin credential、所有 Bearer AI provider secret，以及测试注入的
