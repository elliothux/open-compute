...
```bash
/opt/open-compute/platformd --config /etc/open-compute/platform.toml backup create --name nightly-20260826 --json
/opt/open-compute/platformd --config /etc/open-compute/platform.toml backup inspect --snapshot 0198f000-0000-7000-8000-000000000001 --verify --json
```
