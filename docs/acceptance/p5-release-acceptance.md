...
- [ ] 用专属临时 R2 bucket 完成 AI Search hosted differential：raw key 是否带前导 `/`、include/exclude
  wildcard、opaque checksum、manual overlap/rate-limit response、individual item sync 与 metadata cast。
