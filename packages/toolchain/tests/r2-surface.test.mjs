...
const typesPackage = resolve(import.meta.dirname, "../../workers-types");
const cloudflareTypes = resolve(
  typesPackage,
  "node_modules/@cloudflare/workers-types",
);
const fixture = resolve(
  import.meta.dirname,
  "../../../test/conformance/fixtures/r2/bucket-surface.ts",
);
...
test("strict compile fixture covers pinned R2 members and negative types", async (t) => {
  ...
  await symlink(
    cloudflareTypes,
    join(directory, "node_modules/@cloudflare/workers-types"),
  );
