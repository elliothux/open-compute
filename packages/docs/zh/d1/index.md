...
`id` 必须指向平台上已有的 database。语法见 [绑定](/zh/workers/configuration/bindings)。离线使用 `oc build` / `oc types`，在线使用 `ocd wrangler deploy`。
...
- [上手](/zh/d1/get-started/)
- [概念](/zh/d1/concepts/)
- [指南](/zh/d1/guides/)
- [示例](/zh/d1/examples/)
- [限制](/zh/d1/platform/limits)
- [行为差异](/zh/d1/platform/deviations)
