...
| Outbound network policy | Cloudflare hosted TCP policy | See [TCP sockets](/en/workers/runtime-apis/tcp-sockets) |
| Request-scoped CPU / subrequest quotas | Yes | Not enforced; see [Limits](/en/workers/platform/limits) |
