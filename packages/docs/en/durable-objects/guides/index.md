...
See [Get started](/en/durable-objects/get-started/). The binding must include `className`.
...
Alarms: [alarms](/en/durable-objects/alarms). Hibernation: [WebSockets](/en/workers/runtime-apis/websockets) or [Concepts](/en/durable-objects/concepts/).
