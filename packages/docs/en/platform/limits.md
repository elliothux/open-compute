...
Hosted numbers are on [Workers platform limits](https://developers.cloudflare.com/workers/platform/limits/). Behavior notes: [Behavior differences](/en/platform/deviations).
