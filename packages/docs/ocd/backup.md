...
Restore steps are in the [incident handbook](/ocd/incidents/): current-release restore and fresh-host restore. Restore does not undo external side effects after the snapshot (including the current R2 state).
