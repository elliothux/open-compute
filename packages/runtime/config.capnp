...
const loaderHostWorker :Workerd.Worker = (
  ...
  modules = [
    ...
    (name = "workflows/controller-v2.js", esModule = embed "dist/workflows/controller-v2.js"),
    ...
    (name = "loader/workflow-runner-v2-source", text = embed "dist/workflows/runner-v2.js"),
    (name = "loader/workflow-json-source", text = embed "dist/workflows/json.js"),
    (name = "loader/workflow-json-v2-source", text = embed "dist/workflows/json-v2.js"),
    (name = "loader/workflow-facade-source", text = embed "dist/workflows/facade.js"),
    (name = "loader/workflow-facade-v2-source", text = embed "dist/workflows/facade-v2.js"),
    ...
    (name = "workflows/binding-v2.js", esModule = embed "dist/workflows/binding-v2.js"),
