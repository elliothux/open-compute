import type { WorkflowHandle, WorkflowResolvedInstance, WorkflowTransportV2 } from "./binding-protocol.js";
...
export class WorkflowBindingV2 {
  ...
  async create(options: unknown = {}) {
    ...
    const result = await this.#transport.create({
      id, payloadJson: workflowJson(options.params, "WORKFLOW_PAYLOAD_TOO_LARGE"),
...
function rawTransport(raw: unknown): raw is WorkflowTransportV2 {
